...
const headerUsers = ['User', 'On time / Total', 'Average', 'Detail'];
const headerAudits = ['Audit', 'On time / Total', 'Average', 'Detail'];
...
export default OnTime = () => {
  ...
  const updateDataOnTime = (filtersData) => {
    ...
    ddpConnection.connection.call('swf_general_onTimeCompletion', filter, true, function(error, result) {
